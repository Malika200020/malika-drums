...
const BANDS = [
  {
    name: "Sacrement",
    genre: "Metal",
    description: "Heavy-hitting Sri Lankan metal outfit",
  },
  ...
  return (
    <div className="relative w-full max-w-[360px] mx-auto md:mx-0">
      ...
      <div
        ...
        style={{
          background: `linear-gradient(145deg, ${COLORS.surface["700"]} 0%, ${COLORS.surface["900"]} 100%)`,
        }}
      >
        ...
        {/* "Available" badge */}
        <div
          className="absolute top-3.5 right-3.5 flex items-center gap-1.5 px-2.5 py-1
    ...
    >
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <span className="text-gold text-[0.65rem] font-bold tracking-[0.28em] uppercase">
            About Me
          </span>
        </motion.div>
          ...
          >
            ...
            <div className="space-y-4 text-foreground-dim text-[0.975rem] sm:text-base leading-[1.8]">
              <p>
                ...
                bands such as Breaking Benjamin, Five Finger Death Punch,
                Avenged Sevenfold, and Slipknot, he relentlessly practiced
                double bass techniques every day — transforming raw passion into
                technical precision and power.
              </p>
              <p>
                Now&nbsp;25, Malika is an active member of two prominent Sri
                Lankan bands: the heavy-hitting metal outfit{" "}
                <span className="text-foreground font-medium">Sacrement</span>{" "}
                and the vibrant pop ensemble{" "}
                <span className="text-foreground font-medium">The Cosmos</span>.
                He also maintains a thriving freelance career, delivering
                powerful performances and studio recordings across a wide range
                of genres — from Sinhala pop and classic hits performed with a
                unique personal touch, to the infectious rhythms of Sri Lankan
                baila, and energetic Hindi covers.
              </p>
              <p>
                When he's not behind the kit, Malika creates high-energy
                drumming content for TikTok&nbsp;(@MalikaDrums) and YouTube,
                ...
                {BANDS.map((band) => (
                  ...
                  >
                    ...
                    <div className="leading-tight">
                      ...
                      <p className="text-foreground-muted text-[0.65rem] tracking-wide">
                        {band.genre}
                      </p>
                    </div>
                  </motion.div>
            ...
            <div className="grid grid-cols-3 gap-3 pt-1">
              {STATS.map(({ icon: Icon, value, label }) => (
                ...
                >
                  ...
                  <p className="text-foreground-muted text-[0.65rem] leading-tight">
                    {label}
                  </p>
                </motion.div>
              ))}
