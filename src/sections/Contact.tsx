...
function ContactCard({ href, accent, icon, label, sublabel, detail }: ContactCardProps) {
  const cardV = {
    idle:  { y: 0,  scale: 1,    boxShadow: `0 4px 24px rgba(0,0,0,0.36), 0 0 0 1px rgba(36,36,36,1)` },
    hover: { y: -8, scale: 1.02, boxShadow: `0 32px 64px ${accent}2e, 0 0 0 1px ${accent}55` },
    tap:   { y: -2, scale: 0.99, boxShadow: `0 8px 24px ${accent}18, 0 0 0 1px ${accent}38` },
  }
  const iconV  = {
    idle:  { scale: 1,    y: 0  },
  ...
  return (
    ...
    >
      ...
      <div className="flex-1">
        ...
        <p className="text-foreground-muted text-sm mt-1.5 leading-snug">{sublabel}</p>
      </div>
...
export default function Contact() {
  ...
  const emailHref = `mailto:malikadegaldoruwa@gmail.com?subject=${encodeURIComponent(
    'Booking Inquiry — Malika Degadoruwa',
    ...
    >
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="max-w-[660px] mx-auto">
          ...
          >
            Malika Degadoruwa · Professional Drummer · Colombo, Sri Lanka
          </motion.p>
